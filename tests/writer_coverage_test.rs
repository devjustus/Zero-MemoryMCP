...
mod basic_writer_coverage {
    ...
    fn test_write_all_memory_value_variants() {
        ...
        assert!(writer.write_value(addr, &MemoryValue::String("test".to_string())).is_err());
        assert!(writer.write_value(addr, &MemoryValue::Bytes(vec![1, 2, 3])).is_err());
    }
    ...
    fn test_swap_memory_various_sizes() {
        ...
        assert!(writer.swap_memory(Address::new(0x1000), Address::new(0x2000), 1).is_err());
        assert!(writer.swap_memory(Address::new(0x1000), Address::new(0x2000), 100).is_err());
        assert!(writer.swap_memory(Address::new(0x1000), Address::new(0x2000), 1000).is_err());
    }
    ...
    fn test_write_string_various_lengths() {
        ...
        assert!(writer.write_string(Address::new(0x1000), &"x".repeat(1000)).is_err());
    }
    ...
    fn test_write_wide_string_unicode() {
        ...
        assert!(writer.write_wide_string(Address::new(0x1000), "Hello").is_err());
        assert!(writer.write_wide_string(Address::new(0x1000), "世界").is_err());
        assert!(writer.write_wide_string(Address::new(0x1000), "🎨🎭🎪").is_err());
        assert!(writer.write_wide_string(Address::new(0x1000), "Mixed 混合 Text").is_err());
    }
}
...
mod safe_writer_coverage {
    ...
    fn test_write_verified_different_types() {
        ...
        assert!(writer.write_verified(Address::new(0x1000), std::f32::consts::PI).is_err());
        assert!(writer.write_verified(Address::new(0x1000), std::f64::consts::E).is_err());
    }
    ...
    fn test_write_with_backup_types() {
        ...
        assert!(writer.write_with_backup(Address::new(0x1000), 42u8).is_err());
        assert!(writer.write_with_backup(Address::new(0x1000), 42u16).is_err());
        assert!(writer.write_with_backup(Address::new(0x1000), 42u32).is_err());
        assert!(writer.write_with_backup(Address::new(0x1000), 42u64).is_err());
    }
    ...
    fn test_restore_backup_various_sizes() {
        ...
        assert!(writer.restore_from_backup(Address::new(0x1000), &[1]).is_err());
        assert!(writer.restore_from_backup(Address::new(0x1000), &[1, 2]).is_err());
        assert!(writer.restore_from_backup(Address::new(0x1000), &[1, 2, 3, 4]).is_err());
        assert!(writer.restore_from_backup(Address::new(0x1000), &vec![0; 100]).is_err());
    }
    ...
    fn test_safe_string_operations() {
        ...
        assert!(writer.write_wide_string(Address::new(0x1000), "").is_err());
        assert!(writer.write_wide_string(Address::new(0x1000), "ASCII").is_err());
        assert!(writer.write_wide_string(Address::new(0x1000), "Unicode 世界").is_err());
    }
    ...
    fn test_safe_batch_operations() {
        ...
        let batch_u8 = vec![
            (Address::new(0x1000), 1u8),
            (Address::new(0x2000), 2u8),
        ];
    ...
    fn test_safe_copy_operations() {
        ...
        assert!(writer.copy_memory(Address::new(0x1000), Address::new(0x2000), 100).is_err());
        assert!(writer.copy_memory(Address::new(0x1000), Address::new(0), 100).is_err());
        assert!(writer.copy_memory(Address::new(0), Address::new(0x1000), 100).is_err());
    }
    ...
    fn test_safe_swap_operations() {
        ...
        assert!(writer.swap_memory(Address::new(0x1000), Address::new(0x2000), 100).is_err());
        assert!(writer.swap_memory(Address::new(0), Address::new(0x1000), 100).is_err());
        assert!(writer.swap_memory(Address::new(0x1000), Address::new(0), 100).is_err());
        assert!(writer.swap_memory(Address::new(0), Address::new(0), 100).is_err());
    }
