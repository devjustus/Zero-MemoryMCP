...
fn test_memory_value_conversions() {
    let test_values = vec![
        ...
        (MemoryValue::String("test".to_string()), ValueType::String, 4),
    ];
...
fn test_error_handling_integration() {
    let error = MemoryError::read_failed(
...
fn test_cross_module_serialization() {
    ...
    let module = ModuleInfo::new(
        ...
        Address::new(0x7FF80000),
        0x100000,
    );
    let scan_result = ScanResult::new(
        Address::new(0x7FF80500),
        MemoryValue::I32(42),
    );
